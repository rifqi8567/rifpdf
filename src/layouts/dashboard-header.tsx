      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3 ml-2 pl-2 border-l border-border">
          <div className="hidden sm:flex items-center gap-2">
            <div className="h-8 w-8 rounded-full gradient-bg flex items-center justify-center text-white text-sm font-semibold shadow-sm">
              U
            </div>
            <div className="hidden md:block">
              <p className="text-sm font-medium leading-none">User</p>
              <Badge variant="default" className="mt-0.5 text-[9px]">Free</Badge>
            </div>
          </div>
